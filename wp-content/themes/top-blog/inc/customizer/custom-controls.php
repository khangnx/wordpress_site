<?php
/**
 * Top Blog Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Top_Blog_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_image_checkbox';
	 ...
	 */
	 class Top_Blog_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_text_radio_button';
	 ...
	 */
	class Top_Blog_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_image_radio_button';
	 ...
	 */
	class Top_Blog_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_simple_notice';
	 ...
	 */
	class Top_Blog_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_slider_control';
	 ...
	 */
	class Top_Blog_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_toggle_switch';
	 ...
	 */
	class Top_Blog_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_sortable_repeater';
	 ...
	 */
	class Top_Blog_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_dropdown_select2';
	 ...
	 */
	class Top_Blog_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_dropdown_posts';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			// Get our Posts
			$this->posts = Top_Blog_Customizer_Utilities::get_posts_as_array( $this->input_attrs );
		}
	 ...
	 */
	class Top_Blog_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['topBlogtinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['topBlogtinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['topBlogmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class Top_Blog_Note_Control extends WP_Customize_Control {
		public $type = 'top_blog_description';
	 ...
	 *
	 */
	class Top_Blog_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'top_blog_business_upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="radinat_business_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'top_blog_url_sanitization' ) ) {
		function top_blog_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'top_blog_switch_sanitization' ) ) {
		function top_blog_switch_sanitization( $input ) {
			return $input;
			if ( true === $input ) {
				return 1;
			} else {
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'top_blog_radio_sanitization' ) ) {
		function top_blog_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'top_blog_text_sanitization' ) ) {
		function top_blog_text_sanitization( $input ) {
	 ...
	 */
	function top_blog_sanitize_select( $input, $setting ) {
	 ...
	 */
	function top_blog_sanitize_map_code( $input ) {
		// allow iframe.
